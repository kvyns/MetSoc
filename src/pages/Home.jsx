          ...
          <div className="grid md:grid-cols-3 gap-12 items-center">
            ...
            <div className="md:col-span-2 space-y-6">
              ...
              <div className="space-y-4">
                ...
                The Department of Metallurgical and Materials is one of the youngest departments at IIT Ropar.
                The department is home to 11 faculty members and over 140 students (BTech, MTech and PhD).
                Known for its collegial atmosphere, the department offers BTech, MTech and PhD degree programs.
                In its short history, the department’s alumni have worked for prestigious companies such as JSL, JSW, Dassault Systems, Jio Saavn, Microsoft, etc.
                The doctoral students from the department have landed R&D jobs in companies such as Jasch Industries, post-docs in prestigious universities and labs such as Lehigh University and Argonne National Laboratory, while some have opted for an academic career in esteemed institutions such as Punjab Engineering College
                </p>
                <p className="text-slate-300 text-lg leading-relaxed">
                Over the past seven years, the department has progressed rapidly and we look forward to continued growth and engagement with industries and research organizations,
                with our students being the shining beacons who take up positions in industries and academia and keep our flag flying high.
                In this connection, a career workshop such as EdVantage provides an eye-opener to the world of career opportunities following a degree in materials engineering.
                The department invites you to participate in this event and make it a grand success.
                </p>
              </div>
